...
function fun(){
    ...
    document.getElementById("mydiv4").style.margin="var(--margin4)";
...
function fun11(m){
    ...
    document.getElementById("crd1").style.width="var(--width)";
    ...
    document.getElementById("crd1").style.margin=" var(--margin0)";
    document.getElementById("hid1").style.display="none";
    document.getElementById("hid11").style.display="none";
    document.getElementById("crd1").style.width="var(--width2)";
    }
}
...
function fun12(m){
    ...
    document.getElementById("crd2").style.width="var(--width)";
    document.getElementById("crd2").style.margin="0 0";

}

else{
    document.getElementById("crd2").style.margin=" var(--margin0)";
    document.getElementById("hid2").style.display="none";
    document.getElementById("hid12").style.display="none";
    document.getElementById("crd2").style.width="var(--width2)";
    }}
...
function fun13(m){
    ...
    document.getElementById("crd3").style.width="var(--width)";
    document.getElementById("crd3").style.margin="0 0";

}

else{
    document.getElementById("crd3").style.margin=" var(--margin0)";
    document.getElementById("hid3").style.display="none";
    document.getElementById("hid13").style.display="none";
    document.getElementById("crd3").style.width="var(--width2)";
    }}
...
function fun14(m){
    ...
    document.getElementById("crd4").style.width="var(--width)";
    document.getElementById("crd4").style.margin="0 0";

}

else{
    document.getElementById("crd4").style.margin=" var(--margin0)";
    document.getElementById("hid4").style.display="none";
    document.getElementById("hid14").style.display="none";
    document.getElementById("crd4").style.width="var(--width2)";
    }}
    function fun4(){
       ...
       if(screen.width<=1536){
        ...
        document.getElementById("im1").style.width="var(--hi)";
        document.getElementById("im1").style.height="var(--hi)";
        document.getElementById("m1").style.height="70%";
        document.getElementById("im2").style.width="var(--hi)";
        document.getElementById("im2").style.height="var(--hi)";
        document.getElementById("m2").style.height="70%";
        document.getElementById("im3").style.width="var(--hi)";
        document.getElementById("im3").style.height="var(--hi)";
        document.getElementById("m3").style.height="70%";
        document.getElementById("im3").style.width="var(--hi)";
        document.getElementById("im3").style.height="var(--hi)";
        document.getElementById("m3").style.height="70%";
        document.getElementById("im4").style.width="var(--hi)";
        document.getElementById("im4").style.height="var(--hi)";
        document.getElementById("m4").style.height="70%";
        document.getElementById("im5").style.width="var(--hi)";
        document.getElementById("im5").style.height="var(--hi)";
        document.getElementById("m5").style.height="70%";
        document.getElementById("im6").style.width="var(--hi)";
        document.getElementById("im6").style.height="var(--hi)";
        document.getElementById("m6").style.height="70%";
        document.getElementById("im7").style.width="var(--hi)";
        document.getElementById("im7").style.height="var(--hi)";
        document.getElementById("m7").style.height="70%";
        document.getElementById("im8").style.width="var(--hi)";
        document.getElementById("im8").style.height="var(--hi)";
        document.getElementById("m8").style.height="70%";
        document.getElementById("im9").style.width="var(--hi)";
        document.getElementById("im9").style.height="var(--hi)";
        document.getElementById("m9").style.height="70%";
        document.getElementById("im10").style.width="var(--hi)";
        document.getElementById("im10").style.height="var(--hi)";
        document.getElementById("m10").style.height="70%";
        document.getElementById("im11").style.width="var(--hi)";
        document.getElementById("im11").style.height="var(--hi)";
